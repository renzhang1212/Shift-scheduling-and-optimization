 	...
 	function StackedGantt($this)
 	{
		...
		function sanitizeGeneralHighlightsDates(generalHighlights)
		{
 		...
 		function createTimeHeader(hour)
 		{
 			...
 			$headerItem.html(formatHour2(hour));
 		...
 		function createActivity(activity, $rowValueContainer, row)
 		{
 			...
 			if (activity.shiftNumber != undefined) {
 			    $activity.append('<div style="font-size:20px;line-height:30px;text-align:center">Unassigned: ' + activity.shiftNumber+'</b>');
 			}
